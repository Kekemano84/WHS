...
## Offline trial / PWA test
This build includes a stronger service worker and installable PWA manifest.

How to test on Android Chrome:
1. Deploy normally once and open the app online.
2. Open the pages you want offline at least once: Home, My Calendar, Handover, Yard Check, More, WhatsApp Message, Shift Closure.
3. Chrome menu > Add to Home screen / Install app.
4. Turn off internet and open WHS from the phone home screen.

Notes:
- Cached pages can open offline after first online visit.
- Local drafts can continue working if the page stores them in browser storage.
- Server actions such as login, cloud database save, email sending and some Excel exports still need internet.
